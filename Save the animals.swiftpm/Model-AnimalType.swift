...
struct AnimalType: Identifiable, Hashable, Decodable, Encodable {
    ...
    static var animals: [AnimalType] {
        [
            ...
            AnimalType(image: "Chelonia mydas",
                       speed: 4000,
                       scale: 1.25,
                       description: "The green sea turtle (Chelonia mydas), also known as the green turtle, black (sea) turtle or Pacific green turtle, is a species of large sea turtle of the family Cheloniidae. It is the only species in the genus Chelonia. Its range extends throughout tropical and subtropical seas around the world, with two distinct populations in the Atlantic and Pacific Oceans, but it is also found in the Indian Ocean. The common name refers to the usually green fat found beneath its carapace, not to the color of its carapace, which is olive to black. ts appearance is that of a typical sea turtle. C. mydas has a dorsoventrally flattened body, a beaked head at the end of a short neck, and paddle-like arms well-adapted for swimming. Adult green turtles grow to 1.5 metres (5 ft) long. The average weight of mature individuals is 68–190 kg (150–419 lb) and the average carapace length is 78–112 cm (31–44 in). Exceptional specimens can weigh 315 kg (694 lb) or even more, with the largest known C. mydas having weighed 395 kg (871 lb) and measured 153 cm (60 in) in carapace length.",
                       conservationStatus: "NT"
                      ),
            AnimalType(image: "Epinephelus itajara",
                       speed: 600,
                       scale: 1,
                       description: "The Atlantic goliath grouper or itajara (Epinephelus itajara), formerly known as the jewfish, is a saltwater fish of the grouper family and one of the largest species of bony fish. The species can be found in the west ranging from northeastern Florida, south throughout the Gulf of Mexico and the Caribbean Sea, and along South America to Brazil. In the east the species ranges West Africa from Senegal to Cabinda. The species has been observed at depths ranging from 1 to 100 meters (3 to 328 feet). The Atlantic goliath grouper can grow to lengths of 2.5 meters (8.2 feet) and weigh up to 363 kilograms (800 pounds). The species ranges in coloration from brownish yellow to grey to greenish and has small black dots on the head, body and fins. Individuals less than 1 meter (3.28 feet) in length have 3 to 4 faint vertical bars present on their sides. The species has an elongate body with a broad, flat head and small eyes. The lower jaw has 3 to 5 rows of teeth with no front canines.",
                       conservationStatus: "CR"
                      ),
            
            AnimalType(image: "Balaenoptera musculus",
                       speed: 3000,
                       scale: 3,
            ...
            AnimalType(image: "Spintherobolus papilliferus",
                       speed: 600,
                       scale: 1,
                       description: "Spintherobolus is a genus of characins that are endemic to river basins in southern and southeastern Brazil from Santa Catarina to Rio de Janeiro. All four species in the genus are considered threatened by Brazil's Ministry of the Environment. They are small fish, up to 6.1 cm (2.4 in) in standard length. The eyes of S. papilliferus (18.4-26.0% HL) are the smallest of the four species of Spintherobolus; the caudal peduncle length is the longest, being 23.8-24.6% SL in males and 21.3-27.0% SL in females; the anal-fin rays of adult males are not expanded in a sagittal plane; segments of anal-fin rays of adult males are not fused; an anterior extension of the proximal end of the lepidotrichia of the anal-fin rays of males is absent.",
                       conservationStatus: "EN"
                      ),
            
            AnimalType(image: "Galeorhinus galeus",
                       speed: 900,
                       scale: 2,
            ...
            AnimalType(image: "Hypsolebias auratus",
                       speed: 600,
                       scale: 1,
                       description: "Hypsolebias is a genus of small fish in the family Rivulidae that are endemic the Caatinga, Cerrado and nearby regions in Brazil. The greatest richness is in the São Francisco River basin, but there are also species in the Tocantins, Jequitinhonha and Jaguaribe systems, as well as smaller river basins in northeastern Brazil. Like their relatives, Hypsolebias are annual killifish. The short-lived adults inhabit temporary waters like rain pools, laying their eggs in the bottom. As their habitat dries up the adults die, but the eggs survive and hatch when the water returns in the next season. The males are more colorful than the females, and male colors/patterns are a primary way of separating the different species. They are small fish that reach up to 7 cm (2.8 in) in total length.",
                       conservationStatus: "CR"
                      ),
            
            AnimalType(image: "Carcharhinus isodon",
                       speed: 900,
                       scale: 2,
                       description: "The finetooth shark (Carcharhinus isodon) is a species of requiem shark, in the family Carcharhinidae, found in the western Atlantic Ocean, from North Carolina to Brazil. It forms large schools in shallow, coastal waters, and migrates seasonally following warm water. A relatively small, slender-bodied shark, the finetooth shark can be identified by its needle-like teeth, dark blue-gray dorsal coloration, and long gill slits. It attains a maximum length of 1.9 m (6.2 ft). The diet of this species consists primarily of small bony fishes, in particular menhaden. Like other members of its family, it is viviparous with females giving birth to two to six pups in estuarine nursery areas every other year. Valued for its meat, the finetooth shark forms an important component of the commercial gillnet shark fishery operating off the southeastern United States. Population assessments suggest that this fishery does not currently pose a threat to U.S. populations of the species. This shark is not known to pose a danger to humans, though it snaps vigorously when captured and should be handled with caution.",
                       conservationStatus: "DD"
                      ),
            AnimalType(image: "Leporinus guttatus",
                       speed: 600,
                       scale: 1,
                       description: "Leporinus Agassiz is one of the most species-rich genera in the entire order Characiformes, with approximately 90 valid species (Britski & Garavello, 2003, 2005; Britski & Birindelli, 2008; Santos & Zuanon, 2008). Although several species have been described in the last twenty years (see Britski & Garavello, 2003), recent collection efforts in streams and small tributaries of large river drainages, especially in the Amazon basin, have revealed a still greater number of undescribed species. Fish collections from the Serra do Cachimbo, the highest portion of the Brazilian shield in the Amazon, have revealed a quite rich and endemic fish fauna (Lima & Birindelli, 2006; Birindelli et al., 2009). The area is drained by three major river basins, the rio Curuá, a large tributary of the rio Iriri in the rio Xingu basin, and the rio Teles Pires and the rio Jamanxim, flowing into the rio Tapajós. The rio Curuá near Vila de Cachoeira da Serra (approximately at 08º44'S 54º58'W) drop off from Serra do Cachimbo tablelands in a series of two great waterfalls of approximately 40 and 60 meters deep, separated only by a 50 meters river stretch, that completely isolate the fish fauna in the areas above the falls (Goulding et al., 2003).",
                       conservationStatus: "VU",
                       source: "New species of the genus Leporinus Agassiz"
                      ),
            
            AnimalType(image: "Pontoporia blainvillei",
                       speed: 900,
                       scale: 1.5,
            ...
            AnimalType(image: "Austrolebias jaegari",  speed: 600,
                       scale: 1,
                       description: "A species of fish is Austrolebias jaegari. This was first described by Costa and Cheffe in 2002. Austrolebias jaegari belongs to the genus Austrolebias, and family Rivulidae. This species is propagated by Brazil. There is no such species listed.",
                       conservationStatus: "CR"
                      ),
            
            AnimalType(image: "Characidium vestigipinne",
                       speed: 600,
                       scale: 1,
            ...
            AnimalType(image: "Schroederichthys bivius",
                       speed: 600,
                       scale: 1,
            ...
            AnimalType(image: "Cetorhinus maximus",
                       speed: 900,
                       scale: 2,
